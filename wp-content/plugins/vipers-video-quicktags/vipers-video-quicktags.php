...
//  </script>'
                //echo $fallbacklink;
                $resultat = '<script src="http://www.recetasdemama.es/player/swfobject.js" type="text/javascript"></script><div id="'.$id_video.'">LAS RECETAS DE MAMA</div><script type="text/javascript"> '.$a. ';' .$b. ';' .$c. ';' .$d. ';' .$e. ';' .$f. ';' .$g. ';' .$h. ';</script>';
                return $resultat;
		// Hack until this plugin properly supports iframe-based embeds
		/*if ( ! empty( $iframe ) ) {
